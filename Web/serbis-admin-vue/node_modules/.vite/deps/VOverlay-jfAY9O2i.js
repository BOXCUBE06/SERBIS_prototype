import { C as vShow, Cn as withDirectives, Dt as mergeProps, Ft as onMounted, Gn as readonly, I as Teleport, Kn as ref, M as Fragment, Mn as effectScope, Ot as nextTick, Qn as toRef, U as computed, Ut as provide, Vn as onScopeDispose, W as createBaseVNode, Wn as reactive, Yn as shallowRef, Zn as toRaw, _n as watchEffect, er as toValue, et as createVNode, gn as watch, hn as warn, jt as onBeforeUnmount, n as Transition, xt as inject } from "./vue.runtime.esm-bundler-BbnC8aGa.js";
import { B as isOn, S as destructComputed, W as matchesSelector, _ as clamp, c as getCurrentInstance, d as CircularBuffer, et as templateRef, k as focusableChildren, lt as consoleError, q as omit, r as genericComponent, rt as IN_BROWSER, u as propsFactory, v as convertToUnit, w as eventName } from "./defineComponent-lcd9Cryl.js";
import { a as parseAnchor, i as getAxis, n as flipCorner, r as flipSide, t as flipAlign } from "./anchor-BoJDM3kk.js";
import { c as getOverflow, i as provideTheme, l as getTargetBox, o as Box, r as makeThemeProps, s as getElementBox } from "./theme-BDXZR0n2.js";
import { c as nullifyTransforms, s as animate } from "./transitions-X6ZmnkGV.js";
import { t as makeComponentProps } from "./component-CXvYq-Ov.js";
import { t as deepEqual } from "./deepEqual-B6QKzM_Q.js";
import "./easing-D0Lykq3t.js";
import { a as hasScrollbar, i as getScrollParents, n as useLazy, r as getScrollParent, t as makeLazyProps } from "./lazy-BqO4QuN0.js";
...
import { i as useRtl } from "./locale-DlNJMR7x.js";
import { a as useDisplay } from "./display-Cd5rWVXk.js";
import { i as useRouter, n as useBackButton } from "./router-IyvI8rN-.js";
import { n as makeTransitionProps, t as MaybeTransition } from "./transition-CyT3EYhU.js";
import { i as useDelay, n as useFocusTrap, r as makeDelayProps, t as makeFocusTrapProps } from "./focusTrap-BpksQv1Y.js";
import { t as useScopeId } from "./scopeId-DYiJjKJp.js";
import "C:/Users/User/Documents/CODEZZZ/SERBIS/SERBIS_prototype/Web/serbis-admin-vue/node_modules/vuetify/lib/components/VOverlay/VOverlay.css";
...
function useLocationStrategies(props, data) {
	...
	if (IN_BROWSER) useToggleScope(() => !!(data.isActive.value && props.locationStrategy), (reset) => {
		...
		onScopeDispose(() => {
			...
			if (data.isActive.value) contentStyles.value = {};
		});
...
function getStaticLocationClasses(location) {
	...
	for (const token of normalized.split(" ")) if (token in inline) justify = inline[token];
...
function connectedLocationStrategy(data, props, contentStyles) {
	...
	const [getMinWidth, getMinHeight, getMaxWidth, getMaxHeight] = [
		...
		return () => {
			...
			if (typeof raw === "number" || /^-?[\d.]+(?:px)?$/.test(raw.trim())) return parseFloat(raw);
			if (raw.endsWith("%")) {
...
function useActivator(props, { isActive, isTop, contentEl }) {
	...
	const availableEvents = {
		...
		onMouseenter: (e) => {
			isHovered = true;
			activatorEl.value = e.currentTarget || e.target;
			if (props.target === "cursor") cursorTarget.value = [e.clientX, e.clientY];
			runOpenDelay();
		},
		onMousemove: (e) => {
	...
	const activatorEvents = computed(() => {
		...
		if (props.openOnHover) {
			...
			if (props.target === "cursor" && !openOnClick.value) events.onMousemove = availableEvents.onMousemove;
		}
...
var VOverlay = genericComponent()({
	...
	setup(props, { slots, attrs, emit }) {
		...
		const staticLocationClasses = computed(() => {
			return props.locationStrategy === "static" ? getStaticLocationClasses(props.location) : void 0;
		});
		...
		function returnFocusToActivator() {
			...
			if (!((!activeEl || activeEl === document.body) && openedWithActivatorFocus || activeEl === el || el.contains(activeEl) || ownsFocus(activeEl))) return;
			const parent = el.parentElement;
			const focusableInParent = parent ? focusableChildren(parent) : [];
			let target;
			if (focusableInParent.includes(el)) target = el;
			else {
		...
		useRender(() => createBaseVNode(Fragment, null, [slots.activator?.({
			...
			closeConditional,
			include: () => [activatorEl.value, ...Array.from(document.querySelectorAll(".v-overlay__content")).filter(ownsFocus)]
		}]])] })])] })]));
		return {
			activatorEl,
			scrimEl,
...
//# sourceMappingURL=VOverlay-jfAY9O2i.js.map