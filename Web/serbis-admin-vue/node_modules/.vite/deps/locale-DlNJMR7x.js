import { Kn as ref, Qn as toRef, U as computed, Yn as shallowRef, gn as watch, xt as inject } from "./vue.runtime.esm-bundler-BbnC8aGa.js";
import { j as getObjectValueByPath, lt as consoleError, ut as consoleWarn } from "./defineComponent-lcd9Cryl.js";
...
function inferNumericGroupSeparator(current, fallback) {
	return new Intl.NumberFormat([current.value, fallback.value], { useGrouping: true }).formatToParts(1e4).find((p) => p.type === "group")?.value ?? "\xA0";
}
...
//# sourceMappingURL=locale-DlNJMR7x.js.map