import { $ as createTextVNode, $n as toRefs, Dt as mergeProps, Kn as ref, M as Fragment, Mt as onBeforeUpdate, Ot as nextTick, Qn as toRef, T as withModifiers, U as computed, Ut as provide, W as createBaseVNode, Yn as shallowRef, Zn as toRaw, _n as watchEffect, ar as normalizeClass, cr as toDisplayString, er as toValue, et as createVNode, ft as guardReactiveProps, gn as watch, ir as capitalize, or as normalizeProps, sr as normalizeStyle, xt as inject } from "./vue.runtime.esm-bundler-BbnC8aGa.js";
import { B as isOn, H as keyValues, M as getPropertyFromItem, Q as pickWithRest, R as isEmpty, V as isPrimitive, Z as pick, _ as clamp, c as getCurrentInstance, f as EventProp, j as getObjectValueByPath, lt as consoleError, n as defineFunctionalComponent, nt as wrapInArray, o as provideDefaults, p as callEvent, q as omit, r as genericComponent, u as propsFactory, v as convertToUnit, y as createRange, z as isObject } from "./defineComponent-lcd9Cryl.js";
import { i as provideTheme, r as makeThemeProps } from "./theme-BDXZR0n2.js";
import { t as VExpandTransition } from "./transitions-X6ZmnkGV.js";
import { t as makeComponentProps } from "./component-CXvYq-Ov.js";
import { t as deepEqual } from "./deepEqual-B6QKzM_Q.js";
import { t as useRender } from "./useRender-DTREr3tZ.js";
import { t as useBackgroundColor } from "./color-CEC6B9lw.js";
import { t as makeElevationProps } from "./elevation-BNd_p3M6.js";
import { t as useProxiedModel } from "./proxiedModel-DyW2vJy8.js";
import { i as useRtl, r as useLocale } from "./locale-DlNJMR7x.js";
import { n as IconValue } from "./icons-CzVCuSDB.js";
import { a as useDisplay, i as makeDisplayProps } from "./display-Cd5rWVXk.js";
import { t as useResizeObserver } from "./resizeObserver-CkkAtWka.js";
import { t as makeBorderProps } from "./border-DTSWzMI_.js";
import { n as useDensity, t as makeDensityProps } from "./density-BX5NEVOs.js";
import { t as makeRoundedProps } from "./rounded-D0LFK4Yk.js";
import { t as makeTagProps } from "./tag-BSFSqPf5.js";
import { n as makeVariantProps } from "./variant-QMV2LBlq.js";
import { t as VBtn } from "./VBtn-D0Ys5cK3.js";
import { n as makeSizeProps, t as VIcon } from "./VIcon-TezwG0M4.js";
import { n as makeLoaderProps, r as useLoader, t as LoaderSlot } from "./loader-4oo4xntB.js";
import { t as MaybeTransition } from "./transition-CyT3EYhU.js";
import { n as VCheckboxBtn } from "./VCheckbox-Cfs3A0fm.js";
import { t as VChip } from "./VChip-m2tg6D_d.js";
import { t as VDivider } from "./VDivider-D4T4yLgh.js";
import { a as makeVirtualProps, i as VHighlight, n as makeFilterProps, o as useVirtual, r as useFilter, s as VVirtualScrollItem, t as VSelect } from "./VSelect-CGURKNw4.js";
import "C:/Users/User/Documents/CODEZZZ/SERBIS/SERBIS_prototype/Web/serbis-admin-vue/node_modules/vuetify/lib/components/VDataTable/VDataTable.css";
import "C:/Users/User/Documents/CODEZZZ/SERBIS/SERBIS_prototype/Web/serbis-admin-vue/node_modules/vuetify/lib/components/VDataTable/VDataTableFooter.css";
import "C:/Users/User/Documents/CODEZZZ/SERBIS/SERBIS_prototype/Web/serbis-admin-vue/node_modules/vuetify/lib/components/VPagination/VPagination.css";
import "C:/Users/User/Documents/CODEZZZ/SERBIS/SERBIS_prototype/Web/serbis-admin-vue/node_modules/vuetify/lib/components/VTable/VTable.css";
...
var VPagination = genericComponent()({
	...
	setup(props, { slots, emit }) {
		...
		const range = computed(() => {
			...
			if (props.totalVisible == null && length.value < 3) return createRange(length.value, start.value);
		...
		useRender(() => createVNode(props.tag, {
			...
			[true, "only-first"].includes(props.showFirstLastPage) && createBaseVNode("li", {
				"key": "first",
			...
			props.showFirstLastPage === true && createBaseVNode("li", {
				"key": "last",
...
var makeVDataTableFooterProps = propsFactory({
	...
	...pick(makeVPaginationProps({ showFirstLastPage: true }), ["showFirstLastPage"])
}, "VDataTableFooter");
...
function useLoadingConfig(loading, fallbackColor) {
	return {
		active: computed(() => {
			const v = loading();
...
var VDataTableHeaders = genericComponent()({
	...
	setup(props, { slots }) {
		...
		const VDataTableHeaderCell = ({ column, x, y }) => {
			...
			const sortItem = isSortable ? sortBy.value.find((item) => item.key === column.key) : void 0;
			return createVNode(VDataTableColumn, mergeProps({
				"tag": "th",
				"aria-sort": sortItem?.order === "asc" ? "ascending" : sortItem?.order === "desc" ? "descending" : void 0,
				"align": column.align,
				"class": [{
		...
		const VDataTableMobileHeaderCell = () => {
			...
			}, props.headerProps), { default: () => [createBaseVNode("div", { "class": "v-data-table-header__content" }, [slots["mobile.header"]?.(slotProps.value) ?? createBaseVNode(Fragment, null, [sortableColumns.value.length > 0 && renderSortSelect(), showSelectColumn && renderSelectAll()])])] });
		};
		useRender(() => {
			return mobile.value ? createBaseVNode("tr", null, [createVNode(VDataTableMobileHeaderCell, null, null)]) : createBaseVNode(Fragment, null, [slots.headers ? slots.headers(slotProps.value) : headers.value.map((row, y) => createBaseVNode("tr", null, [row.map((column, x) => createVNode(VDataTableHeaderCell, {
				...
				"x": x,
				"y": y
			}, null))])), loadingConfig.active.value && ["start", "both"].includes(loadingConfig.side.value) && createBaseVNode("tr", { "class": "v-data-table-progress" }, [createBaseVNode("th", { "colspan": columns.value.length }, [createVNode(LoaderSlot, {
...
function createGroupBy(props) {
	return {
		groupBy: useProxiedModel(props, "groupBy"),
		opened: useProxiedModel(props, "opened"),
		openAll: toRef(() => props.openAll),
		groupKey: toRef(() => props.groupKey)
	};
}
...
var defaultGroupId = (key, value, parentKey) => `${parentKey}_${key}_${value}`;
...
function useOpenAllGroups(opened, openAll, items, groupBy, groupKey) {
	watch(computed(() => {
		if (!toValue(openAll) || !groupBy.value.length) return /* @__PURE__ */ new Set();
		...
		let changed = false;
		for (const id of newIds) if (!oldIds?.has(id) && !current.has(id)) {
			current.add(id);
			changed = true;
		}
		for (const id of oldIds ?? []) if (!newIds.has(id) && current.has(id)) {
			current.delete(id);
			changed = true;
		}
...
function useGroupedItems(items, groupBy, opened, hasSummary, isGroupOpen, groupKey) {
...
function provideExpanded(props) {
	...
	function expand(item, value) {
		...
		const newExpanded = value && props.expandStrategy === "single" ? /* @__PURE__ */ new Set() : new Set(expanded.value);
		if (!value) {
	...
	setup(props, { slots }) {
		...
		useRender(() => createBaseVNode("tr", {
			...
			return createVNode(VDataTableColumn, mergeProps({
				...
				const displayValue = matches?.length ? createVNode(VHighlight, {
					"text": text,
					"matches": matches
				}, null) : text;
	...
	setup(props, { attrs, slots }) {
		...
		useRender(() => {
			...
			return createBaseVNode(Fragment, null, [props.items.map((item, index) => {
				...
				return createBaseVNode(Fragment, { "key": itemSlotProps.props.key }, [slots.item ? slots.item(itemSlotProps) : createVNode(VDataTableRow, itemSlotProps.props, slots), slots["expanded-row"] ? isExpanded(item) && slots["expanded-row"](slotProps) : slots.expanded && createBaseVNode("tr", { "class": "v-data-table__tr--expanded" }, [createBaseVNode("td", { "colspan": columns.value.length }, [props.expandTransition ? createVNode(MaybeTransition, { "transition": props.expandTransition }, { default: () => [isExpanded(item) ? createBaseVNode("div", null, [slots.expanded(slotProps)]) : null] }) : isExpanded(item) && createBaseVNode("div", null, [slots.expanded(slotProps)])])])]);
			})]);
		});
		return {};
	}
...
var VTable = genericComponent()({
	...
	setup(props, { attrs, slots, emit }) {
		...
		useRender(() => {
			...
			return createVNode(props.tag, mergeProps(rootAttrs, {
				"class": [
					"v-table",
				...
				}, [createBaseVNode("table", normalizeProps(guardReactiveProps(tableAttrs)), [slots.caption?.(), slots.default()])]) : slots.wrapper?.(),
				slots.bottom?.()
			] });
		});
		return {};
...
var VDataTable = genericComponent()({
	...
	setup(props, { attrs, slots }) {
		...
		const { sortByWithGroups, opened: openedGroups, extractRows, isGroupOpen, toggleGroup } = provideGroupBy({
			groupBy,
			sortBy,
			disableSort,
			opened
			...
			return createVNode(VTable, mergeProps({
				...
				default: () => slots.default ? slots.default(slotProps.value) : createBaseVNode(Fragment, null, [
					...
					!props.hideDefaultBody && createBaseVNode("tbody", null, [
						...
						slots.body ? slots.body(slotProps.value) : createVNode(VDataTableRows, mergeProps(attrs, dataTableRowsProps, {
							"items": paginatedItems.value,
							"getMatches": getMatches
						}), slots),
						slots["body.append"]?.(slotProps.value),
						loadingConfig.active.value && ["end", "both"].includes(loadingConfig.side.value) && createBaseVNode("tr", { "class": "v-data-table-progress v-data-table-progress--bottom" }, [createBaseVNode("th", { "colspan": columns.value.length }, [createVNode(LoaderSlot, {
							"name": "v-data-table-progress",
							"absolute": true,
							"active": true,
							"color": loadingConfig.color.value,
		...
		useRender(() => {
			...
			return createVNode(VTable, mergeProps({
				...
				wrapper: () => createBaseVNode("div", {
					...
					"class": "v-table__wrapper",
					"style": { height: convertToUnit(props.height) }
				}, [createBaseVNode("table", normalizeProps(guardReactiveProps(tableAttrs)), [
					slots.caption?.(),
					slots.colgroup?.(slotProps.value),
					!props.hideDefaultHeader && createBaseVNode("thead", { "key": "thead" }, [createVNode(VDataTableHeaders, mergeProps(dataTableHeadersProps, { "multiSort": !!props.multiSort }), slots)]),
					slots.thead?.(slotProps.value),
					!props.hideDefaultBody && createBaseVNode("tbody", { "key": "tbody" }, [
						...
						slots["body.prepend"]?.(slotProps.value),
						createVNode(VDataTableRows, mergeProps(attrs, dataTableRowsProps, {
...
var VDataTableServer = genericComponent()({
	...
	setup(props, { attrs, slots }) {
		...
		const { opened: openedGroups, isGroupOpen, toggleGroup, extractRows } = provideGroupBy({
			groupBy,
			sortBy,
			disableSort,
			opened
