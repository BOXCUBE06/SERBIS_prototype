import { Kn as ref, Nn as getCurrentScope, Qn as toRef, U as computed, Ut as provide, Vn as onScopeDispose, Yn as shallowRef, _n as watchEffect, gn as watch, xt as inject } from "./vue.runtime.esm-bundler-BbnC8aGa.js";
import { G as mergeDeep, at as PREFERS_REDUCED_MOTION, c as getCurrentInstance, dt as deprecate, it as IS_WEBKIT, rt as IN_BROWSER, st as SUPPORTS_MATCH_MEDIA, u as propsFactory, ut as consoleWarn, y as createRange } from "./defineComponent-lcd9Cryl.js";
import { c as parseColor, i as hasLightForeground, n as darken, r as getLuma, s as lighten, t as RGBtoHex } from "./colorUtils-C9p8hHOH.js";
...
function genCssVariables(theme, prefix) {
	...
	for (const [key, value] of Object.entries(theme.variables)) {
		...
		const rgb = color ? `${color.r}, ${color.g}, ${color.b}` + (color.a == null ? "" : `, ${color.a}`) : void 0;
...
function createTheme(options) {
	...
	function setTransitionOrigin(e) {
		...
		const originX = Math.min(98.9, 100 * x / window.innerWidth);
	...
	function resolveTransitionOptions(transition) {
		if (!(transition ?? parsedOptions.transition) && !_transitionOrigin) return false;
	...
	function change(themeName, transition) {
		...
		if (transitionOptions) return withPageTransition(apply, transitionOptions);
		apply();
		return Promise.resolve();
	}
	function cycle(themeArray = themeNames.value, transition) {
		const currentIndex = themeArray.indexOf(name.value);
		return change(themeArray[currentIndex === -1 ? 0 : (currentIndex + 1) % themeArray.length], transition);
	}
...
//#endregion
export { useTheme as a, getOverflow as c, provideTheme as i, getTargetBox as l, createTheme as n, Box as o, makeThemeProps as r, getElementBox as s, ThemeSymbol as t };

//# sourceMappingURL=theme-BDXZR0n2.js.map